  ...
  >
    ...
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="6">
          <h1 class="red--text text--darken-4 top">mohand heitham</h1>
          <h1 class="white--text">Web Developer</h1>
          <p class="grey--text">
            HTML/CSS JavaScript/Vue.js , python software <br />
            front-end, for flutter/dart | Passionate about creating and develop UI,
            <br />
          ...
          <div class="first" id="project">
            <v-row>
              ...
              <v-col cols="12" class="mt-10">
                <div class="child1">
                  <h1 class="red--text text--darken-4 mt-4 number">2</h1>
                ...
                <div class="child2">
                  <v-row>
                    <v-col cols="12" class="childcol">
                      <div class="child2 mButton padding bgColor1">
                        <h1 class="red--text text--darken-4">==</h1>
            ...
            <div class="secondchild1" id="contact">
              <v-row>
                <v-col cols="7">
                  ...
                  <p class="grey--text">
                    mohandhetham888@gmail.com<br />
                    +9647722580905<br />
                    https://github.com/mohandhaithamt.
